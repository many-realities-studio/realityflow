...
{
    /// <summary>
    /// Custom altered version of TMP - Input Field. This is because TMP - Input Field doesn't
    /// play nice with unity ui's auto layout stuff, so I had to make some tweaks to make it 
    /// behave. 
    /// Now it works quite well, scales automatically, respects more layout properties, etc.
    /// </summary>
    [AddComponentMenu("UI/Custom - Input Field", 11)]
    public class Custom_InputField : Selectable,
        ...
        IScrollHandler
    {
        ...
        protected override void OnEnable()
        {
            ...
            ILayoutGroup parentGroup = transform.parent != null
                ? transform.parent.GetComponent<ILayoutGroup>()
                : null;

            if (layoutController != null || parentGroup != null)
            {
            ...
            if (Application.isPlaying)
            {
                if (m_CachedInputRenderer == null && m_TextComponent != null)
                {
                    ...
                    caretRectTrans.anchorMin = new(0, 0);
                    caretRectTrans.anchorMax = new(1, 1);
        ...
        public virtual float preferredWidth
        {
            get
            {
                ...
                return LayoutUtility.GetPreferredWidth(m_TextViewport) + m_CaretWidth + horizontalPadding;
            }
        }
        ...
        public virtual float preferredHeight
        {
            get
            {
                ...
                return LayoutUtility.GetPreferredHeight(m_TextViewport) + verticalPadding;
            }
        }
