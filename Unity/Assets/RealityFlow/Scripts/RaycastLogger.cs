...
public class RaycastLogger : MonoBehaviour
{
    ...
    private async void SpawnObjectAtHitLocation()
    {
        ...
        GameObject currentObject = await RealityFlowAPI.Instance.SpawnPrefab(selectedObjectName, visualIndicatorInstance.transform.position, Vector3.one, Quaternion.identity, RealityFlowAPI.SpawnScope.Room);
