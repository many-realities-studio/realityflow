...
public class PopulateObjectLibrary : MonoBehaviour
{
    ...
    async void TriggerObjectSpawn(GameObject objectPrefab)
    {
        ...
        GameObject spawnedObject = await RealityFlowAPI.Instance.SpawnObject(objectPrefab.name, spawnScript.GetVisualIndicatorPosition(), objectPrefab.transform.localScale, defaultRotation, RealityFlowAPI.SpawnScope.Room);
